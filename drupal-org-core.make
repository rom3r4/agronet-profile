...
projects[pressflow][patch][] = http://drupal.org/files/spark-install-1780598-5.patch
...
projects[pressflow][patch][] = http://drupal.org/files/1074108-skip-profile-16-7.x-do-not-test.patch

; This patch allows install profile to list requirements on the install page
; http://drupal.org/node/1971072
projects[pressflow][patch][] = http://drupal.org/files/install_profile_requirements_on_install.patch

; This patch allows install profiles to set a minimum memory limit.
; http://drupal.org/node/1772316#comment-6457618
projects[pressflow][patch][] = http://drupal.org/files/drupal-7.x-allow_profile_change_sys_req-1772316-21.patch

; Allow to specify SCRIPT HTML element attributes through drupal_add_js()
; http://drupal.org/node/1664602#comment-6221066
projects[pressflow][patch][] = http://drupal.org/files/1664602-1.patch
